...
namespace YoungHero
{
    ...
    public class NpcList
    {
        ...
        public NpcList()
        {
            ...
            npcList.Add(new NpcData(210125, "谷月軒"));
            ...
            npcList.Add(new NpcData(210156, "鋼刀盟眾"));
            npcList.Add(new NpcData(210157, "鋼刀盟眾"));
            npcList.Add(new NpcData(210158, "幽谷客"));
            ...
            npcList.Add(new NpcData(210180, "酆都鬼眾"));
            npcList.Add(new NpcData(210181, "傀屍門毒人"));
            npcList.Add(new NpcData(210182, "傀屍門毒人"));
            npcList.Add(new NpcData(210183, "傀屍門毒人"));
            ...
            npcList.Add(new NpcData(500116, "修羅宮弟子"));
            ...
            npcList.Add(new NpcData(600087, "孟婆"));
            ...
            npcList.Add(new NpcData(600096, "谷月軒-A"));
            npcList.Add(new NpcData(600097, "谷月軒-B"));
            npcList.Add(new NpcData(600100, "騙子少女"));
            npcList.Add(new NpcData(600101, "阿疙兒"));
            npcList.Add(new NpcData(600102, "判官"));
            npcList.Add(new NpcData(600158, "幽谷客"));
            npcList.Add(new NpcData(600159, "傀屍"));
            ...
            npcList.Add(new NpcData(800015, "谷月軒"));
            npcList.Add(new NpcData(800016, "荊棘"));
            npcList.Add(new NpcData(800035, "沈湘芸"));
            npcList.Add(new NpcData(800036, "古實"));
            npcList.Add(new NpcData(800057, "秦紅殤"));
            npcList.Add(new NpcData(800075, "江瑜"));
            npcList.Add(new NpcData(800091, "楊雲"));
            npcList.Add(new NpcData(800092, "傅劍寒"));
            npcList.Add(new NpcData(800094, "任劍南"));
            npcList.Add(new NpcData(800098, "蕭遙"));
            npcList.Add(new NpcData(800104, "毒"));
            npcList.Add(new NpcData(800105, "浪"));
            npcList.Add(new NpcData(800106, "狂"));
            npcList.Add(new NpcData(820005, "傀屍"));
            npcList.Add(new NpcData(820013, "賽王爺"));
            npcList.Add(new NpcData(820075, "天意菁英"));
            npcList.Add(new NpcData(890013, "賽王爺"));
            npcList.Add(new NpcData(890014, "酆都麗鬼"));
            npcList.Add(new NpcData(890023, "葉孤"));
            npcList.Add(new NpcData(890024, "花玖瑟"));
            npcList.Add(new NpcData(890025, "金熙鳳"));
            npcList.Add(new NpcData(890026, "尹世允"));
            npcList.Add(new NpcData(990024, "花玖瑟"));
            npcList.Add(new NpcData(990025, "金熙鳳"));
